...
void protoRemote(AsyncResponseStream *response) {
  ...
  response->print("<title>ProtoRemote</title>");
  ...
  response->print("<link rel='icon' href='https://i.imgur.com/JZYrHBI.png'>");
  ...
  response->print("nav:hover { background-color:rgb(255, 255, 255); transition-duration: 0.4s; font-size: 18px; display: flex; align-items: center; position: relative; }");
  ...
  response->print("nav:hover a { color: rgb(0, 0, 0); }");
  ...
  response->print("<p class='small-text'>(Estimate)</p>");
  response->print("</div>");
  ...
  response->print(" °C</p>");
  response->print("<p class='small-text'>(±2°C)</p>");
  response->print("</div>");
  ...
  response->print(" %</p>");
  response->print("<p class='small-text'>(±5%)</p>");
  response->print("</div>");
  ...
  response->print("<a href='https://github.com/Aprocryphan/AproGen' style='text-decoration: underline; color: #aaa; display: inline-block; margin-top: 5px;' target='_blank'>");
